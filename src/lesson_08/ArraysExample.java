...
public class ArraysExample {
    public static void main(String[] args) {
        ...
        System.out.println("Мы можем производить с полученным значением допустимые типом данных операции "
                + (digits[3] / 2 - 15));
        ...
        System.out.println("array[2]: " + array[2]); // проверяем значения в ячейках, массивов,
        // заполненных значениями пол умолчанию
        System.out.println("strings[5]: " + strings[5]); // попытка вызова у null каких-либо методов вызовет исключение
        // (аварийное завершение программы)

        strings[5] = "Pascal"; // изменяем значение в ячейке с индексом 5

        System.out.println("strings[5]: " + strings[5]); // попытка вызова у null каких-либо методов вызовет
        // исключение (аварийное завершение программы)
