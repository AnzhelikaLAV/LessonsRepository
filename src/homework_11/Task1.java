...
//
// 1.)     {1, 4, 3, 6, 7} -> распечатывает [7, 6, 3, 4, 1]
// Перегрузить метод, если в него приходит индекс, то часть массива слева до этого индекса распечатывается в обычном порядке,
//
// 2.) 1-м методом: а начиная с этого индекса в обратном:
// {1, 4, 3, 6, 7} + индекс 2 - > распечатывает [1, 4, 7, 6, 3]

// 3.) 2м методом: Еще одна перегрузка: метод принимает массив и булевый флаг.
...
public class Task1 {
    public static void main(String[] args) {
        ...
        public static void printReverseArray(int[] array, int index) {
            ...
            // 2. надо перебрать индексы по убыванию от index до максимального индекса в массиве (длина - 1) и
            // распечатать все элементы с этими индексами
        ...
        public static void printReverseArray(int[] array, boolean flag) { //3-e задание
